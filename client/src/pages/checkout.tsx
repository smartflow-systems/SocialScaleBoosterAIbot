  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: "Welcome to SFS ScaleBots Pro!",
      });
    }
  };
    ...
    <div className="min-h-screen bg-dark-bg py-12">
      <div className="max-w-2xl mx-auto px-4">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-accent-gold mb-2">Upgrade to Pro</h1>
          <p className="text-neutral-gray">Unlock unlimited bot creation and premium features</p>
        </div>
